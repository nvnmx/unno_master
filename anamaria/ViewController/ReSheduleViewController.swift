...
import FSCalendar
  ...
  protocol ReSheduleViewControllerProtocol {
    func seActualizoCita()
}

class ReSheduleViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource, PopUpReSheduleControllerProtocol {
   
    
    var delegate : ReSheduleViewControllerProtocol!
    ...
    func actualizarCita() {
           // si llega aqui es porque ya se guardo
        self.dismiss(animated: true, completion: nil)
                       self.delegate.seActualizoCita()
       }
    ...
    @IBAction func save(_ sender: Any) {
        ...
        let popVc : PopUpReSheduleController = self.storyboard!.instantiateViewController(withIdentifier: "PopUpReSheduleController") as! PopUpReSheduleController
        
        popVc.genDate = self.genDate
        popVc.firstHour =  self.hrIni
        popVc.lastHour =  self.hrFin
        popVc.shedule = self.shedule
        popVc.delegate = self
...
extension ReSheduleViewController: FSCalendarDataSource, FSCalendarDelegate{
